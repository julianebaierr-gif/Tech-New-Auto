export const metadata = {
  title: "Terms of Service & Editorial Usage | TechPulse",
  description: "Review the TechPulse terms of service, intellectual property guidelines, code snippet licensing, and editorial liability disclaimers.",
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12 text-slate-700 leading-relaxed text-sm sm:text-base">
      <header className="border-b border-slate-200 pb-8 space-y-3">
        ...
        <p className="text-xs text-slate-500">Last Revised: September 2026 | TechPulse Media Group</p>
      </header>

      <section className="space-y-4">
        <h2 className="text-2xl font-bold text-slate-900 tracking-tight">1. Acceptance of Terms</h2>
        <p>
          By accessing, browsing, or citing materials published by <strong>TechPulse</strong> (the "Publication"), you enter into a binding agreement governed by these Terms of Service. If you do not accept these terms in full, your authorization to use this website, its API endpoints, or its syndicate feeds is immediately revoked.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          TechPulse publishes research commentary, benchmark assessments, and investigative computing articles crafted by experienced engineering journalists:
        </p>
      ...
      <section className="space-y-4">
        ...
        <p>
          All original journalism, investigative graphics, and site branding published on TechPulse are protected under international copyright law:
        </p>
        <div className="space-y-3 pl-2 text-sm text-slate-600">
          ...
          <div>
            ...
            <p className="mt-1">
              Short quotations (up to 150 words) may be republished under Fair Use doctrine, provided that direct canonical attribution and an active hyperlink to the original TechPulse article URL are preserved. Automated whole-site scraping, mass mirroring, or unauthorized full-text syndication is strictly prohibited.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-slate-600 text-sm leading-relaxed">
          The services, content, and code on TechPulse are provided on an "as is" and "as available" basis without express or implied warranties of any kind. In no event shall TechPulse, its editors, authors, or corporate affiliates be held liable for any direct, indirect, incidental, or consequential damages resulting from system downtime, reliance on published technical reports, or implementation outcomes.
        </p>
      </section>
